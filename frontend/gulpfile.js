...
function images_webp() {
    watch(``, {usePolling: true}, parallel(images_no_compres));
...
export {scripts, styles, images, images_webp,images_no_compres, smartGrid, fonts, deploy};
export let assets = series(scripts, styles, parallel(images, images_webp,images_no_compres));
export default series((done) => {
    ...
    scripts,
    styles,
    parallel(images, images_webp,images_no_compres, fonts),
